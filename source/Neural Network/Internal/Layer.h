...
namespace OddityEngine::NeuralNetwork {
    class Layer {
    protected:
        inline static long double default_weight = 1;
        inline static long double default_bias = 0;
    ...
    public:
        ...
        virtual void evolve(long double rate) = 0;
        virtual Vector<> forward(const Vector<>& input) = 0;
        virtual Vector<> backward(const Vector<>& output_gradient, long double learning_rate) = 0;
