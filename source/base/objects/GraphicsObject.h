...
public:
    ...
    GraphicsObject(const vec3 &pos=vec3(0), const vec3 &dir=vec3(0, 1, 0), const string &vertexShader=loadShader("shaders/vert.shader"), const string &fragmentShader=loadShader("shaders/frag.shader"));
